...
/**
 * Gera um nome japonês aleatório
 * @param {string} genero - 'masculino', 'feminino' ou 'aleatorio' (padrão)
 * @returns {string} Nome completo (sobrenome + nome)
 */
...
/**
 * Gera um nome de maldição estilo japonês
 * @returns {string} Nome da maldição (ex: "Kyō no Kage")
 */
